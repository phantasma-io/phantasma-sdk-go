...
func (t testSerializable) Serialize(w *BinWriter) {
	w.WriteU16LE(uint16(t))
}

// DecodeBinary implements io.Serializable interface.
func (t *testSerializable) Deserialize(r *BinReader) {
...
// EncodeBinary implements io.Serializable interface.
func (t *testPtrSerializable) Serialize(w *BinWriter) {
	w.WriteU16LE(uint16(*t))
}

// DecodeBinary implements io.Serializable interface.
func (t *testPtrSerializable) Deserialize(r *BinReader) {
