...
1. Check the open [issues](https://github.com/phantasma-io/phantasma-sdk-go/issues) and
[pull requests](https://github.com/phantasma-io/phantasma-sdk-go/pulls) for existing discussions.
